...
`Disable rolling number animations`: Disables rolling number animations of video view count, upload time, and user likes
...
`Remove tracking query parameter`: Remove the tracking query parameter from links.
...
`Enable slide to seek`: Enable slide to seek instead of playing at 2x speed.
